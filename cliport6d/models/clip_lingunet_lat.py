...
class CLIPLingUNetLat(nn.Module):
    ...
    def __init__(self, input_shape, output_dim, cfg, device, preprocess):
        ...
        # for ablation on the language representation of pickup_object task
        # self.height_emb = nn.Embedding(3, 1024)
    ...
    def forward(self, x, lat, l):
        ...
        # heights = torch.LongTensor(heights).to(self.height_emb.weight.device)
        # l_input = self.height_emb(heights)
        # l_mask = None
