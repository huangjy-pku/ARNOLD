...
class TransporterAgent_6Dof(TransporterAgent):
    ...
    def obs_preprocess(self, obs, bounds, pixel_size):
        ...
        colors = [front_rgb, wrist_rgb, left_rgb, base_rgb, wrist_bottom_rgb]
        pcds = [front_point_cloud, wrist_point_cloud, left_point_cloud, base_point_cloud, wrist_bottom_point_cloud]
